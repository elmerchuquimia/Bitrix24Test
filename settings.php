<?php
define('C_REST_CLIENT_ID','local.6302a370df55e2.11282379');//Application ID
define('C_REST_CLIENT_SECRET','d5TkgosSvVIyNiDUHqYs1euhbV0NFLwtSOAp2YH2i32ZRq3x5G');//Application key
// or
